...
**Проблема была**: Админ бот создавал заявки на вывод в личном кабинете, обновлял статистику, но уведомления не приходили админам.

**Корень проблемы найден**: Неправильные telegram_id в базе данных
- @a888bnd хранился как telegram_id: 194 (database ID вместо real telegram_id)
- @DimaOsadchuk хранился как telegram_id: 888888888 (фиктивный ID)
...
2. **Отключены дубликаты**: Неправильные записи больше не админы (is_admin=false)
3. **Живой тест пройден**: Уведомления успешно доставлены всем админам
...
- ✅ Система показала 100% доставку: 2/2 админа получили сообщения

**Логи подтверждают**: `[AdminBot] Уведомления о выводе отправлены {"total":2,"sent":2}`
