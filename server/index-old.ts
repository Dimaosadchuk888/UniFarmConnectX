...
// Импорт стабильного Telegram middleware
...
async function startServer(): Promise<void> {
  ...
  // Hardcoded endpoints удалены - используются реальные данные из routes-new.ts
  ...
  try {
    ...
    // Используем реальные данные из БД через routes-new.ts
