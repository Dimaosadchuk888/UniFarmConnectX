...
Проверьте настройки или запустите приложение через start-with-neon.sh
  ...
  try {
    // Подготавливаем консолидированные контроллеры
    console.log('[Server] Подготовка консолидированных контроллеров...');
    
    // Затем загружаем новые маршруты с консолидированными контроллерами
    import('./routes-new')
      .then(module => {
