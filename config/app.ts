...
export const appConfig = {
  ...
  apiVersion: 'v2',
  baseUrl: process.env.APP_DOMAIN || process.env.BASE_URL || 'https://uni-farm-connect-x-elizabethstone1.replit.app',
  ...
  appDomain: process.env.APP_DOMAIN || process.env.BASE_URL || 'https://uni-farm-connect-x-elizabethstone1.replit.app'
};