...
export const insertUniFarmingDepositSchema = createInsertSchema(uniFarmingDeposits).omit({ id: true, created_at: true, updated_at: true });
  user_id: true,
  amount: true,
...
export const insertBoostDepositSchema = createInsertSchema(boostDeposits).omit({ id: true, created_at: true, updated_at: true });
  user_id: true,
  boost_id: true,
  start_date: true,
  end_date: true,
...
export const insertTonBoostDepositSchema = createInsertSchema(tonBoostDeposits).omit({ id: true, created_at: true, updated_at: true });
  user_id: true,
...
export const insertPartitionLogSchema = createInsertSchema(partition_logs).omit({ id: true, created_at: true, updated_at: true });
  operation: true,
  partition_name: true,
  message: true,
  timestamp: true,
...
export const insertRewardDistributionLogSchema = createInsertSchema(reward_distribution_logs).omit({ id: true, created_at: true, updated_at: true });
  batch_id: true,
  source_user_id: true,
  earned_amount: true,
  currency: true,
...
export const insertPerformanceMetricSchema = createInsertSchema(performance_metrics).omit({ id: true, created_at: true, updated_at: true });
  operation: true,
  batch_id: true,
  duration_ms: true,
  timestamp: true,
...
export const insertBoostPackageSchema = createInsertSchema(boostPackages).omit({ id: true, created_at: true, updated_at: true });
  name: true,
  description: true,
  price_uni: true,
...
export const insertUserBoostSchema = createInsertSchema(userBoosts).omit({ id: true, created_at: true, updated_at: true });
  user_id: true,
  package_id: true,
  amount: true,
  daily_rate: true,
...
export const insertTonBoostPackageSchema = createInsertSchema(tonBoostPackages).omit({ id: true, created_at: true, updated_at: true });
  name: true,
  description: true,
  price_ton: true,
  bonus_uni: true,
...
export const insertLaunchLogSchema = createInsertSchema(launchLogs).omit({ id: true, created_at: true, updated_at: true });
