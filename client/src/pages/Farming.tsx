...
const Farming: React.FC = () => {
  ...
  // [FIX: REMOVE FARMING BUTTON] Настройка кнопок при загрузке страницы
  React.useEffect(() => {
    console.log('[FARMING PAGE] 🔘 Настройка кнопок фарминга...');
    
    // [FIX: REMOVE FARMING BUTTON] Убираем кнопку "Начать фарминг" из нижней панели
    // Кнопка больше не отображается - не мешает интерфейсу
    
    // Показываем только кнопку возврата на главную
