    ...
    <div className="container mx-auto p-4 md:p-8">
      ...
      <div className="bg-card rounded-lg p-4 mb-8">
        ...
        <ul className="list-disc list-inside space-y-2">
          <li>
            <a 
              href="https://t.me/UniFarmingBot/app" 
              target="_blank" 
              rel="noopener noreferrer"
              className="text-primary hover:underline"
            >
              Открыть Mini App - https://t.me/UniFarmingBot/app
            </a>
          </li>
          <li>
            <a 
      ...
      <div className="bg-card rounded-lg p-4">
        ...
        <ol className="list-decimal list-inside space-y-3">
          ...
          <li>
            Правильный формат реферальной ссылки: <code className="bg-muted px-1 py-0.5 rounded">https://t.me/UniFarmingBot/app?startapp=ref_КОД</code>
          </li>
          <li>
